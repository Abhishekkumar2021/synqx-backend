...
def create_connection(
    ...
    try:
        ...
        connection = service.create_connection(connection_create, tenant_id)
...
def update_connection(
    ...
    try:
        ...
        connection = service.update_connection(
            connection_id, connection_update, tenant_id
        )
...
def delete_connection(
    ...
    try:
        service = ConnectionService(db)
        service.delete_connection(connection_id, tenant_id, hard_delete=hard_delete)
        return None
...
def test_connection(
    ...
    try:
        ...
        result = service.test_connection(
            connection_id, tenant_id, custom_config=test_request.config
        )
        return result
...
def create_asset(
    ...
    try:
        service = ConnectionService(db)
        asset = service.create_asset(asset_create, tenant_id)
...
def get_asset(
    ...
    service = ConnectionService(db)
    asset = service.get_asset(asset_id, tenant_id)
...
def update_asset(
    ...
    try:
        service = ConnectionService(db)
        asset = service.update_asset(asset_id, asset_update, tenant_id)
...
def delete_asset(
    ...
    try:
        service = ConnectionService(db)
        service.delete_asset(asset_id, tenant_id, hard_delete=hard_delete)
        return None
...
@router.post(
    "/assets/{asset_id}/discover-schema",
...
@router.get(
    "/assets/{asset_id}/schema-versions",
